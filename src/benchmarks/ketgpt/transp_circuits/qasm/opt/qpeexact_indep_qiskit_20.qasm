...
rz(pi) psi[0];
h psi[0];
rz(1.3464815971288844) psi[0];
cx psi[0], q[0];
rz(1.3464815971288848) q[0];
cx psi[0], q[0];
rz(-1.3464815971288848) q[0];
cx psi[0], q[1];
rz(-0.44862945933202325) q[1];
cx psi[0], q[1];
rz(0.44862945933202325) q[1];
cx psi[0], q[2];
rz(-0.8972589186640465) q[2];
cx psi[0], q[2];
rz(0.8972589186640465) q[2];
cx psi[0], q[3];
rz(1.3470748162617001) q[3];
cx psi[0], q[3];
rz(-1.3470748162617001) q[3];
cx psi[0], q[4];
rz(-0.44744302106639294) q[4];
cx psi[0], q[4];
rz(0.44744302106639294) q[4];
cx psi[0], q[5];
rz(-0.8948860421327859) q[5];
cx psi[0], q[5];
rz(0.8948860421327859) q[5];
cx psi[0], q[6];
rz(1.3518205693242213) q[6];
cx psi[0], q[6];
rz(-1.3518205693242213) q[6];
cx psi[0], q[7];
rz(-0.43795151494135054) q[7];
cx psi[0], q[7];
rz(0.43795151494135054) q[7];
cx psi[0], q[8];
rz(-0.8759030298827011) q[8];
cx psi[0], q[8];
rz(0.8759030298827011) q[8];
cx psi[0], q[9];
rz(1.389786593824391) q[9];
cx psi[0], q[9];
rz(-2.9575149590435164) q[9];
cx psi[0], q[10];
rz(-0.3620194659410113) q[10];
cx psi[0], q[10];
rz(0.3620194659410113) q[10];
cx q[8], q[10];
cx q[10], q[8];
