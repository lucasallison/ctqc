...
s psi[0];
h psi[0];
rz(0.10236668093773134) psi[0];
cx psi[0], q[0];
rz(-0.10236668093773134) q[0];
cx psi[0], q[0];
rz(0.10236668093773134) q[0];
rz(0.20473336187546268) psi[0];
cx psi[0], q[1];
rz(-0.20473336187546268) q[1];
cx psi[0], q[1];
rz(0.20473336187546268) q[1];
rz(0.40946672375092535) psi[0];
cx psi[0], q[2];
rz(-0.40946672375092535) q[2];
cx psi[0], q[2];
rz(0.40946672375092535) q[2];
rz(0.8189334475018507) psi[0];
cx psi[0], q[3];
rz(-0.8189334475018507) q[3];
cx psi[0], q[3];
rz(0.8189334475018507) q[3];
rz(-1.5037257585860917) psi[0];
cx psi[0], q[4];
rz(1.5037257585860917) q[4];
cx psi[0], q[4];
rz(-1.5037257585860917) q[4];
rz(0.13414113641760989) psi[0];
cx psi[0], q[5];
rz(-0.13414113641760989) q[5];
cx psi[0], q[5];
rz(0.13414113641760989) q[5];
rz(0.26828227283521977) psi[0];
cx psi[0], q[6];
rz(-0.26828227283521977) q[6];
cx psi[0], q[6];
rz(0.26828227283521977) q[6];
rz(0.5365645456704395) psi[0];
cx psi[0], q[7];
rz(-0.5365645456704395) q[7];
cx psi[0], q[7];
rz(0.5365645456704395) q[7];
rz(1.073129091340879) psi[0];
cx psi[0], q[8];
rz(-1.073129091340879) q[8];
cx psi[0], q[8];
rz(1.073129091340879) q[8];
rz(-0.995334470908035) psi[0];
cx psi[0], q[9];
rz(0.995334470908035) q[9];
cx psi[0], q[9];
rz(-0.995334470908035) q[9];
rz(1.1509237117737232) psi[0];
cx psi[0], q[10];
rz(-1.1509237117737232) q[10];
cx psi[0], q[10];
rz(1.1509237117737232) q[10];
rz(-0.8397452300423466) psi[0];
cx psi[0], q[11];
rz(0.8397452300423466) q[11];
cx psi[0], q[11];
rz(-0.8397452300423466) q[11];
rz(1.4621021935051) psi[0];
cx psi[0], q[12];
rz(-1.4621021935051) q[12];
cx psi[0], q[12];
rz(1.4621021935051) q[12];
rz(-0.21738826657959334) psi[0];
cx psi[0], q[13];
rz(0.21738826657959334) q[13];
cx psi[0], q[13];
rz(-0.21738826657959334) q[13];
rz(-0.4347765331591867) psi[0];
cx psi[0], q[14];
