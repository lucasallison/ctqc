...
s psi[0];
h psi[0];
rz(0.10236860709059971) psi[0];
cx psi[0], q[0];
rz(-0.10236860709059971) q[0];
cx psi[0], q[0];
rz(0.10236860709059971) q[0];
rz(0.20473721418119942) psi[0];
cx psi[0], q[1];
rz(-0.20473721418119942) q[1];
cx psi[0], q[1];
rz(0.20473721418119942) q[1];
rz(0.40947442836239883) psi[0];
cx psi[0], q[2];
rz(-0.40947442836239883) q[2];
cx psi[0], q[2];
rz(0.40947442836239883) q[2];
rz(0.8189488567247977) psi[0];
cx psi[0], q[3];
rz(-0.8189488567247977) q[3];
cx psi[0], q[3];
rz(0.8189488567247977) q[3];
rz(-1.5036949401401978) psi[0];
cx psi[0], q[4];
rz(1.5036949401401978) q[4];
cx psi[0], q[4];
rz(-1.5036949401401978) q[4];
rz(0.13420277330939767) psi[0];
cx psi[0], q[5];
rz(-0.13420277330939767) q[5];
cx psi[0], q[5];
rz(0.13420277330939767) q[5];
rz(0.26840554661879534) psi[0];
cx psi[0], q[6];
rz(-0.26840554661879534) q[6];
cx psi[0], q[6];
rz(0.26840554661879534) q[6];
rz(0.5368110932375907) psi[0];
cx psi[0], q[7];
rz(-0.5368110932375907) q[7];
cx psi[0], q[7];
rz(0.5368110932375907) q[7];
rz(1.0736221864751814) psi[0];
cx psi[0], q[8];
rz(-1.0736221864751814) q[8];
cx psi[0], q[8];
rz(1.0736221864751814) q[8];
rz(-0.9943482806394304) psi[0];
cx psi[0], q[9];
rz(0.9943482806394304) q[9];
cx psi[0], q[9];
rz(-0.9943482806394304) q[9];
rz(1.1528960923109324) psi[0];
cx psi[0], q[10];
rz(-1.1528960923109324) q[10];
cx psi[0], q[10];
rz(1.1528960923109324) q[10];
rz(-0.8358004689679283) psi[0];
cx psi[0], q[11];
rz(0.8358004689679283) q[11];
cx psi[0], q[11];
rz(-0.8358004689679283) q[11];
rz(1.4699917156539366) psi[0];
cx psi[0], q[12];
rz(-1.4699917156539366) q[12];
cx psi[0], q[12];
rz(1.4699917156539366) q[12];
rz(-0.20160922228191988) psi[0];
cx psi[0], q[13];
rz(0.20160922228191988) q[13];
cx psi[0], q[13];
rz(-0.20160922228191988) q[13];
rz(-0.40321844456383976) psi[0];
cx psi[0], q[14];
rz(0.40321844456383976) q[14];
cx psi[0], q[14];
rz(-0.40321844456383976) q[14];
rz(-0.8064368891276795) psi[0];
cx psi[0], q[15];
rz(0.8064368891276795) q[15];
cx psi[0], q[15];
rz(-0.8064368891276795) q[15];
rz(1.528718875334434) psi[0];
cx psi[0], q[16];
rz(-1.528718875334434) q[16];
cx psi[0], q[16];
rz(1.528718875334434) q[16];
rz(-0.08415490292092508) psi[0];
cx psi[0], q[17];
rz(0.08415490292092508) q[17];
cx psi[0], q[17];
rz(-0.08415490292092508) q[17];
rz(-0.16830980584185015) psi[0];
cx psi[0], q[18];
rz(0.16830980584185015) q[18];
cx psi[0], q[18];
rz(-0.16830980584185015) q[18];
rz(-0.3366196116837003) psi[0];
cx psi[0], q[19];
rz(0.3366196116837003) q[19];
cx psi[0], q[19];
rz(-0.3366196116837003) q[19];
rz(-0.6732392233674006) psi[0];
cx psi[0], q[20];
rz(0.6732392233674006) q[20];
cx psi[0], q[20];
rz(-0.6732392233674006) q[20];
rz(-1.3464784467348012) psi[0];
cx psi[0], q[21];
rz(1.3464784467348012) q[21];
cx psi[0], q[21];
rz(-1.3464784467348012) q[21];
rz(0.4486357601201907) psi[0];
cx psi[0], q[22];
rz(-0.4486357601201907) q[22];
cx psi[0], q[22];
rz(0.4486357601201907) q[22];
rz(0.8972715202403814) psi[0];
cx psi[0], q[23];
rz(-0.8972715202403814) q[23];
cx psi[0], q[23];
rz(0.8972715202403814) q[23];
rz(-1.3470496131090304) psi[0];
cx psi[0], q[24];
rz(1.3470496131090304) q[24];
cx psi[0], q[24];
rz(-1.3470496131090304) q[24];
rz(0.4474934273717322) psi[0];
cx psi[0], q[25];
rz(-0.4474934273717322) q[25];
cx psi[0], q[25];
rz(0.4474934273717322) q[25];
rz(0.8949868547434644) psi[0];
cx psi[0], q[26];
rz(-0.8949868547434644) q[26];
cx psi[0], q[26];
rz(0.8949868547434644) q[26];
rz(-pi/134217728) q[26];
rz(-1.3516189441028643) psi[0];
cx psi[0], q[27];
rz(1.3516189441028643) q[27];
cx psi[0], q[27];
rz(-1.3516189441028643) q[27];
cx q[25], q[27];
cx q[27], q[25];
...
rz(-pi/4) q[51];
h q[52];
barrier q[0], q[1], q[2], q[3], q[4], q[5], q[6], q[7], q[8], q[9], q[10], q[11], q[12], q[13], q[14], q[15], q[16], q[17], q[18], q[19], q[20], q[21], q[22], q[23], q[24], q[25], q[26], q[27], q[28], q[29], q[30], q[31], q[32], q[33], q[34], q[35], q[36], q[37], q[38], q[39], q[40], q[41], q[42], q[43], q[44], q[45], q[46], q[47], q[48], q[49], q[50], q[51], q[52], psi[0];
c[0] = measure q[0];
c[1] = measure q[1];
c[2] = measure q[2];
c[3] = measure q[3];
