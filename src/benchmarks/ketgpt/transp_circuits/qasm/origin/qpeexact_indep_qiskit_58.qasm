...
s psi[0];
h psi[0];
rz(0.10236902175985693) psi[0];
cx psi[0], q[0];
rz(-0.10236902175985693) q[0];
cx psi[0], q[0];
rz(0.10236902175985693) q[0];
rz(0.20473804351971386) psi[0];
cx psi[0], q[1];
rz(-0.20473804351971386) q[1];
cx psi[0], q[1];
rz(0.20473804351971386) q[1];
rz(0.4094760870394277) psi[0];
cx psi[0], q[2];
rz(-0.4094760870394277) q[2];
cx psi[0], q[2];
rz(0.4094760870394277) q[2];
rz(0.8189521740788555) psi[0];
cx psi[0], q[3];
rz(-0.8189521740788555) q[3];
cx psi[0], q[3];
rz(0.8189521740788555) q[3];
rz(-1.5036883054320822) psi[0];
cx psi[0], q[4];
rz(1.5036883054320822) q[4];
cx psi[0], q[4];
rz(-1.5036883054320822) q[4];
rz(0.13421604272562868) psi[0];
cx psi[0], q[5];
rz(-0.13421604272562868) q[5];
cx psi[0], q[5];
rz(0.13421604272562868) q[5];
rz(0.26843208545125735) psi[0];
cx psi[0], q[6];
rz(-0.26843208545125735) q[6];
cx psi[0], q[6];
rz(0.26843208545125735) q[6];
rz(0.5368641709025147) psi[0];
cx psi[0], q[7];
rz(-0.5368641709025147) q[7];
cx psi[0], q[7];
rz(0.5368641709025147) q[7];
rz(1.0737283418050294) psi[0];
cx psi[0], q[8];
rz(-1.0737283418050294) q[8];
cx psi[0], q[8];
rz(1.0737283418050294) q[8];
rz(-0.9941359699797343) psi[0];
cx psi[0], q[9];
rz(0.9941359699797343) q[9];
cx psi[0], q[9];
rz(-0.9941359699797343) q[9];
rz(1.1533207136303245) psi[0];
cx psi[0], q[10];
rz(-1.1533207136303245) q[10];
cx psi[0], q[10];
rz(1.1533207136303245) q[10];
rz(-0.8349512263291439) psi[0];
cx psi[0], q[11];
rz(0.8349512263291439) q[11];
cx psi[0], q[11];
rz(-0.8349512263291439) q[11];
rz(1.4716902009315054) psi[0];
cx psi[0], q[12];
rz(-1.4716902009315054) q[12];
cx psi[0], q[12];
rz(1.4716902009315054) q[12];
rz(-0.19821225172678258) psi[0];
cx psi[0], q[13];
rz(0.19821225172678258) q[13];
cx psi[0], q[13];
rz(-0.19821225172678258) q[13];
rz(-0.39642450345356517) psi[0];
cx psi[0], q[14];
rz(0.39642450345356517) q[14];
cx psi[0], q[14];
rz(-0.39642450345356517) q[14];
rz(-0.7928490069071303) psi[0];
cx psi[0], q[15];
rz(0.7928490069071303) q[15];
cx psi[0], q[15];
rz(-0.7928490069071303) q[15];
rz(1.5558946397755324) psi[0];
cx psi[0], q[16];
rz(-1.5558946397755324) q[16];
cx psi[0], q[16];
rz(1.5558946397755324) q[16];
rz(-0.029803374038728077) psi[0];
cx psi[0], q[17];
rz(0.029803374038728077) q[17];
cx psi[0], q[17];
rz(-0.029803374038728077) q[17];
rz(-0.059606748077456154) psi[0];
cx psi[0], q[18];
rz(0.059606748077456154) q[18];
cx psi[0], q[18];
rz(-0.059606748077456154) q[18];
rz(-0.11921349615491231) psi[0];
cx psi[0], q[19];
rz(0.11921349615491231) q[19];
cx psi[0], q[19];
rz(-0.11921349615491231) q[19];
rz(-0.23842699230982461) psi[0];
cx psi[0], q[20];
rz(0.23842699230982461) q[20];
cx psi[0], q[20];
rz(-0.23842699230982461) q[20];
rz(-0.47685398461964923) psi[0];
cx psi[0], q[21];
rz(0.47685398461964923) q[21];
cx psi[0], q[21];
rz(-0.47685398461964923) q[21];
rz(-0.9537079692392985) psi[0];
cx psi[0], q[22];
...
rz(-pi/4) q[55];
h q[56];
barrier q[0], q[1], q[2], q[3], q[4], q[5], q[6], q[7], q[8], q[9], q[10], q[11], q[12], q[13], q[14], q[15], q[16], q[17], q[18], q[19], q[20], q[21], q[22], q[23], q[24], q[25], q[26], q[27], q[28], q[29], q[30], q[31], q[32], q[33], q[34], q[35], q[36], q[37], q[38], q[39], q[40], q[41], q[42], q[43], q[44], q[45], q[46], q[47], q[48], q[49], q[50], q[51], q[52], q[53], q[54], q[55], q[56], psi[0];
c[0] = measure q[0];
c[1] = measure q[1];
c[2] = measure q[2];
c[3] = measure q[3];
