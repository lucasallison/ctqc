...
s psi[0];
h psi[0];
rz(0.10222885254659912) psi[0];
cx psi[0], q[0];
rz(-0.10222885254659912) q[0];
cx psi[0], q[0];
rz(0.10222885254659912) q[0];
rz(0.20445770509319824) psi[0];
cx psi[0], q[1];
rz(-0.20445770509319824) q[1];
cx psi[0], q[1];
rz(0.20445770509319824) q[1];
rz(0.4089154101863965) psi[0];
cx psi[0], q[2];
rz(-0.4089154101863965) q[2];
cx psi[0], q[2];
rz(0.4089154101863965) q[2];
rz(0.817830820372793) psi[0];
cx psi[0], q[3];
rz(-0.817830820372793) q[3];
cx psi[0], q[3];
rz(0.817830820372793) q[3];
rz(-1.5059310128442072) psi[0];
cx psi[0], q[4];
rz(1.5059310128442072) q[4];
cx psi[0], q[4];
rz(-1.5059310128442072) q[4];
rz(0.1297306279013786) psi[0];
cx psi[0], q[5];
rz(-0.1297306279013786) q[5];
cx psi[0], q[5];
rz(0.1297306279013786) q[5];
rz(0.2594612558027572) psi[0];
cx psi[0], q[6];
rz(-0.2594612558027572) q[6];
cx psi[0], q[6];
rz(0.2594612558027572) q[6];
rz(0.5189225116055144) psi[0];
cx psi[0], q[7];
rz(-0.5189225116055144) q[7];
cx psi[0], q[7];
rz(0.5189225116055144) q[7];
rz(1.0378450232110288) psi[0];
cx psi[0], q[8];
rz(-1.0378450232110288) q[8];
cx psi[0], q[8];
rz(1.0378450232110288) q[8];
rz(-1.0659026071677353) psi[0];
cx psi[0], q[9];
rz(1.0659026071677353) q[9];
cx psi[0], q[9];
rz(-1.0659026071677353) q[9];
rz(1.0097874392543222) psi[0];
cx psi[0], q[10];
rz(-1.0097874392543222) q[10];
cx psi[0], q[10];
rz(1.0097874392543222) q[10];
rz(-1.1220177750811486) psi[0];
cx psi[0], q[11];
rz(1.1220177750811486) q[11];
cx psi[0], q[11];
rz(-1.1220177750811486) q[11];
rz(0.897557103427496) psi[0];
cx psi[0], q[12];
rz(-0.897557103427496) q[12];
cx psi[0], q[12];
rz(0.897557103427496) q[12];
rz(-1.3464784467348012) psi[0];
cx psi[0], q[13];
rz(1.3464784467348012) q[13];
cx psi[0], q[13];
rz(-1.3464784467348012) q[13];
rz(0.4486357601201907) psi[0];
cx psi[0], q[14];
rz(-0.4486357601201907) q[14];
cx psi[0], q[14];
rz(0.4486357601201907) q[14];
rz(0.8972715202403814) psi[0];
cx psi[0], q[15];
rz(-0.8972715202403814) q[15];
cx psi[0], q[15];
rz(0.8972715202403814) q[15];
rz(-1.3470496131090304) psi[0];
cx psi[0], q[16];
rz(1.3470496131090304) q[16];
cx psi[0], q[16];
rz(-1.3470496131090304) q[16];
rz(0.4474934273717322) psi[0];
cx psi[0], q[17];
rz(-0.4474934273717322) q[17];
cx psi[0], q[17];
rz(0.4474934273717322) q[17];
...
cx psi[0], q[21];
rz(-0.8767095307681287) q[21];
cx psi[0], q[21];
rz(0.8767095307681287) q[21];
rz(-1.3881735920535356) psi[0];
cx psi[0], q[22];
rz(1.3881735920535356) q[22];
cx psi[0], q[22];
rz(-1.3881735920535356) q[22];
rz(-pi/8388608) q[22];
rz(0.36524546948272196) psi[0];
cx psi[0], q[23];
rz(-0.36524546948272196) q[23];
cx psi[0], q[23];
rz(0.36524546948272196) q[23];
cx q[21], q[23];
cx q[23], q[21];
...
rz(-pi/4) q[43];
h q[44];
barrier q[0], q[1], q[2], q[3], q[4], q[5], q[6], q[7], q[8], q[9], q[10], q[11], q[12], q[13], q[14], q[15], q[16], q[17], q[18], q[19], q[20], q[21], q[22], q[23], q[24], q[25], q[26], q[27], q[28], q[29], q[30], q[31], q[32], q[33], q[34], q[35], q[36], q[37], q[38], q[39], q[40], q[41], q[42], q[43], q[44], psi[0];
c[0] = measure q[0];
c[1] = measure q[1];
c[2] = measure q[2];
c[3] = measure q[3];
