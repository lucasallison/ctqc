...
s psi[0];
h psi[0];
rz(0.10237267196077061) psi[0];
cx psi[0], q[0];
rz(-0.10237267196077061) q[0];
cx psi[0], q[0];
rz(0.10237267196077061) q[0];
rz(0.20474534392154123) psi[0];
cx psi[0], q[1];
rz(-0.20474534392154123) q[1];
cx psi[0], q[1];
rz(0.20474534392154123) q[1];
rz(0.40949068784308246) psi[0];
cx psi[0], q[2];
rz(-0.40949068784308246) q[2];
cx psi[0], q[2];
rz(0.40949068784308246) q[2];
rz(0.8189813756861649) psi[0];
cx psi[0], q[3];
rz(-0.8189813756861649) q[3];
cx psi[0], q[3];
rz(0.8189813756861649) q[3];
rz(-1.5036299022174633) psi[0];
cx psi[0], q[4];
rz(1.5036299022174633) q[4];
cx psi[0], q[4];
rz(-1.5036299022174633) q[4];
rz(0.1343328491548667) psi[0];
cx psi[0], q[5];
rz(-0.1343328491548667) q[5];
cx psi[0], q[5];
rz(0.1343328491548667) q[5];
rz(0.2686656983097334) psi[0];
cx psi[0], q[6];
rz(-0.2686656983097334) q[6];
cx psi[0], q[6];
rz(0.2686656983097334) q[6];
rz(0.5373313966194668) psi[0];
cx psi[0], q[7];
rz(-0.5373313966194668) q[7];
cx psi[0], q[7];
rz(0.5373313966194668) q[7];
rz(1.0746627932389337) psi[0];
cx psi[0], q[8];
rz(-1.0746627932389337) q[8];
cx psi[0], q[8];
rz(1.0746627932389337) q[8];
rz(-0.992267067111926) psi[0];
cx psi[0], q[9];
rz(0.992267067111926) q[9];
cx psi[0], q[9];
rz(-0.992267067111926) q[9];
rz(1.157058519365941) psi[0];
cx psi[0], q[10];
rz(-1.157058519365941) q[10];
cx psi[0], q[10];
rz(1.157058519365941) q[10];
rz(-0.8274756148579108) psi[0];
cx psi[0], q[11];
rz(0.8274756148579108) q[11];
cx psi[0], q[11];
rz(-0.8274756148579108) q[11];
rz(1.4866414238739716) psi[0];
cx psi[0], q[12];
rz(-1.4866414238739716) q[12];
cx psi[0], q[12];
rz(1.4866414238739716) q[12];
rz(-0.16830980584185015) psi[0];
cx psi[0], q[13];
rz(0.16830980584185015) q[13];
cx psi[0], q[13];
rz(-0.16830980584185015) q[13];
rz(-0.3366196116837003) psi[0];
cx psi[0], q[14];
rz(0.3366196116837003) q[14];
cx psi[0], q[14];
rz(-0.3366196116837003) q[14];
rz(-0.6732392233674006) psi[0];
cx psi[0], q[15];
rz(0.6732392233674006) q[15];
cx psi[0], q[15];
rz(-0.6732392233674006) q[15];
rz(-1.3464784467348012) psi[0];
cx psi[0], q[16];
rz(1.3464784467348012) q[16];
cx psi[0], q[16];
rz(-1.3464784467348012) q[16];
rz(0.4486357601201907) psi[0];
cx psi[0], q[17];
rz(-0.4486357601201907) q[17];
cx psi[0], q[17];
rz(0.4486357601201907) q[17];
rz(0.8972715202403814) psi[0];
cx psi[0], q[18];
rz(-0.8972715202403814) q[18];
cx psi[0], q[18];
rz(0.8972715202403814) q[18];
...
cx psi[0], q[21];
rz(-0.8949868547434644) q[21];
cx psi[0], q[21];
rz(0.8949868547434644) q[21];
rz(-1.3516189441028643) psi[0];
cx psi[0], q[22];
rz(1.3516189441028643) q[22];
cx psi[0], q[22];
rz(-1.3516189441028643) q[22];
rz(0.43835476538406437) psi[0];
cx psi[0], q[23];
rz(-0.43835476538406437) q[23];
cx psi[0], q[23];
rz(0.43835476538406437) q[23];
rz(-pi/16777216) q[23];
