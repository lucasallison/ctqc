...
s psi[0];
h psi[0];
rz(0.10236900504261696) psi[0];
cx psi[0], q[0];
rz(-0.10236900504261696) q[0];
cx psi[0], q[0];
rz(0.10236900504261696) q[0];
rz(0.20473801008523393) psi[0];
cx psi[0], q[1];
rz(-0.20473801008523393) q[1];
cx psi[0], q[1];
rz(0.20473801008523393) q[1];
rz(0.40947602017046786) psi[0];
cx psi[0], q[2];
rz(-0.40947602017046786) q[2];
cx psi[0], q[2];
rz(0.40947602017046786) q[2];
rz(0.8189520403409357) psi[0];
cx psi[0], q[3];
rz(-0.8189520403409357) q[3];
cx psi[0], q[3];
rz(0.8189520403409357) q[3];
rz(-1.5036885729079217) psi[0];
cx psi[0], q[4];
rz(1.5036885729079217) q[4];
cx psi[0], q[4];
rz(-1.5036885729079217) q[4];
rz(0.1342155077739497) psi[0];
cx psi[0], q[5];
rz(-0.1342155077739497) q[5];
cx psi[0], q[5];
rz(0.1342155077739497) q[5];
rz(0.2684310155478994) psi[0];
cx psi[0], q[6];
rz(-0.2684310155478994) q[6];
cx psi[0], q[6];
rz(0.2684310155478994) q[6];
rz(0.5368620310957988) psi[0];
cx psi[0], q[7];
rz(-0.5368620310957988) q[7];
cx psi[0], q[7];
rz(0.5368620310957988) q[7];
rz(1.0737240621915976) psi[0];
cx psi[0], q[8];
rz(-1.0737240621915976) q[8];
cx psi[0], q[8];
rz(1.0737240621915976) q[8];
rz(-0.994144529206598) psi[0];
cx psi[0], q[9];
rz(0.994144529206598) q[9];
cx psi[0], q[9];
rz(-0.994144529206598) q[9];
rz(1.153303595176597) psi[0];
cx psi[0], q[10];
rz(-1.153303595176597) q[10];
cx psi[0], q[10];
rz(1.153303595176597) q[10];
rz(-0.834985463236599) psi[0];
cx psi[0], q[11];
rz(0.834985463236599) q[11];
cx psi[0], q[11];
rz(-0.834985463236599) q[11];
rz(1.4716217271165952) psi[0];
cx psi[0], q[12];
rz(-1.4716217271165952) q[12];
cx psi[0], q[12];
rz(1.4716217271165952) q[12];
rz(-0.19834919935660283) psi[0];
cx psi[0], q[13];
rz(0.19834919935660283) q[13];
cx psi[0], q[13];
rz(-0.19834919935660283) q[13];
rz(-0.39669839871320567) psi[0];
cx psi[0], q[14];
rz(0.39669839871320567) q[14];
cx psi[0], q[14];
rz(-0.39669839871320567) q[14];
rz(-0.7933967974264113) psi[0];
cx psi[0], q[15];
rz(0.7933967974264113) q[15];
cx psi[0], q[15];
rz(-0.7933967974264113) q[15];
rz(1.5547990587369704) psi[0];
cx psi[0], q[16];
rz(-1.5547990587369704) q[16];
cx psi[0], q[16];
rz(1.5547990587369704) q[16];
rz(-0.031994536115852276) psi[0];
cx psi[0], q[17];
rz(0.031994536115852276) q[17];
cx psi[0], q[17];
rz(-0.031994536115852276) q[17];
rz(-0.06398907223170455) psi[0];
cx psi[0], q[18];
rz(0.06398907223170455) q[18];
cx psi[0], q[18];
rz(-0.06398907223170455) q[18];
rz(-0.1279781444634091) psi[0];
cx psi[0], q[19];
rz(0.1279781444634091) q[19];
cx psi[0], q[19];
rz(-0.1279781444634091) q[19];
rz(-0.2559562889268182) psi[0];
cx psi[0], q[20];
rz(0.2559562889268182) q[20];
cx psi[0], q[20];
rz(-0.2559562889268182) q[20];
rz(-0.5119125778536364) psi[0];
cx psi[0], q[21];
rz(0.5119125778536364) q[21];
cx psi[0], q[21];
rz(-0.5119125778536364) q[21];
rz(-1.0238251557072728) psi[0];
cx psi[0], q[22];
rz(1.0238251557072728) q[22];
cx psi[0], q[22];
rz(-1.0238251557072728) q[22];
rz(1.0939423421752474) psi[0];
cx psi[0], q[23];
rz(-1.0939423421752474) q[23];
cx psi[0], q[23];
rz(1.0939423421752474) q[23];
rz(-0.9537079692392985) psi[0];
cx psi[0], q[24];
rz(0.9537079692392985) q[24];
cx psi[0], q[24];
rz(-0.9537079692392985) q[24];
rz(1.2341767151111962) psi[0];
cx psi[0], q[25];
rz(-1.2341767151111962) q[25];
cx psi[0], q[25];
rz(1.2341767151111962) q[25];
rz(-0.6732392233674006) psi[0];
cx psi[0], q[26];
rz(0.6732392233674006) q[26];
cx psi[0], q[26];
rz(-0.6732392233674006) q[26];
rz(-1.3464784467348012) psi[0];
cx psi[0], q[27];
rz(1.3464784467348012) q[27];
cx psi[0], q[27];
rz(-1.3464784467348012) q[27];
rz(0.4486357601201907) psi[0];
cx psi[0], q[28];
rz(-0.4486357601201907) q[28];
cx psi[0], q[28];
rz(0.4486357601201907) q[28];
rz(0.8972715202403814) psi[0];
cx psi[0], q[29];
rz(-0.8972715202403814) q[29];
cx psi[0], q[29];
rz(0.8972715202403814) q[29];
rz(-pi/1073741824) q[29];
rz(-1.3470496131090304) psi[0];
cx psi[0], q[30];
rz(1.3470496131090304) q[30];
cx psi[0], q[30];
rz(-1.3470496131090304) q[30];
cx q[28], q[30];
cx q[30], q[28];
...
rz(-pi/4) q[57];
h q[58];
barrier q[0], q[1], q[2], q[3], q[4], q[5], q[6], q[7], q[8], q[9], q[10], q[11], q[12], q[13], q[14], q[15], q[16], q[17], q[18], q[19], q[20], q[21], q[22], q[23], q[24], q[25], q[26], q[27], q[28], q[29], q[30], q[31], q[32], q[33], q[34], q[35], q[36], q[37], q[38], q[39], q[40], q[41], q[42], q[43], q[44], q[45], q[46], q[47], q[48], q[49], q[50], q[51], q[52], q[53], q[54], q[55], q[56], q[57], q[58], psi[0];
c[0] = measure q[0];
c[1] = measure q[1];
c[2] = measure q[2];
c[3] = measure q[3];
