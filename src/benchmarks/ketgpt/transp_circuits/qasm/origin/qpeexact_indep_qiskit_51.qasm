...
s psi[0];
h psi[0];
rz(0.10236411273390686) psi[0];
cx psi[0], q[0];
rz(-0.10236411273390686) q[0];
cx psi[0], q[0];
rz(0.10236411273390686) q[0];
rz(0.20472822546781372) psi[0];
cx psi[0], q[1];
rz(-0.20472822546781372) q[1];
cx psi[0], q[1];
rz(0.20472822546781372) q[1];
rz(0.40945645093562744) psi[0];
cx psi[0], q[2];
rz(-0.40945645093562744) q[2];
cx psi[0], q[2];
rz(0.40945645093562744) q[2];
rz(0.8189129018712549) psi[0];
cx psi[0], q[3];
rz(-0.8189129018712549) q[3];
cx psi[0], q[3];
rz(0.8189129018712549) q[3];
rz(-1.5037668498472834) psi[0];
cx psi[0], q[4];
rz(1.5037668498472834) q[4];
cx psi[0], q[4];
rz(-1.5037668498472834) q[4];
rz(0.13405895389522618) psi[0];
cx psi[0], q[5];
rz(-0.13405895389522618) q[5];
cx psi[0], q[5];
rz(0.13405895389522618) q[5];
rz(0.26811790779045236) psi[0];
cx psi[0], q[6];
rz(-0.26811790779045236) q[6];
cx psi[0], q[6];
rz(0.26811790779045236) q[6];
rz(0.5362358155809047) psi[0];
cx psi[0], q[7];
rz(-0.5362358155809047) q[7];
cx psi[0], q[7];
rz(0.5362358155809047) q[7];
rz(1.0724716311618094) psi[0];
cx psi[0], q[8];
rz(-1.0724716311618094) q[8];
cx psi[0], q[8];
rz(1.0724716311618094) q[8];
rz(-0.9966493912661744) psi[0];
cx psi[0], q[9];
rz(0.9966493912661744) q[9];
cx psi[0], q[9];
rz(-0.9966493912661744) q[9];
rz(1.1482938710574444) psi[0];
cx psi[0], q[10];
rz(-1.1482938710574444) q[10];
cx psi[0], q[10];
rz(1.1482938710574444) q[10];
rz(-0.8450049114749044) psi[0];
cx psi[0], q[11];
rz(0.8450049114749044) q[11];
cx psi[0], q[11];
rz(-0.8450049114749044) q[11];
rz(1.4515828306399843) psi[0];
cx psi[0], q[12];
rz(-1.4515828306399843) q[12];
cx psi[0], q[12];
rz(1.4515828306399843) q[12];
rz(-0.23842699230982461) psi[0];
cx psi[0], q[13];
rz(0.23842699230982461) q[13];
cx psi[0], q[13];
rz(-0.23842699230982461) q[13];
rz(-0.47685398461964923) psi[0];
cx psi[0], q[14];
rz(0.47685398461964923) q[14];
cx psi[0], q[14];
rz(-0.47685398461964923) q[14];
rz(-0.9537079692392985) psi[0];
cx psi[0], q[15];
rz(0.9537079692392985) q[15];
cx psi[0], q[15];
rz(-0.9537079692392985) q[15];
rz(1.2341767151111962) psi[0];
cx psi[0], q[16];
rz(-1.2341767151111962) q[16];
cx psi[0], q[16];
rz(1.2341767151111962) q[16];
rz(-0.6732392233674006) psi[0];
cx psi[0], q[17];
rz(0.6732392233674006) q[17];
cx psi[0], q[17];
rz(-0.6732392233674006) q[17];
rz(-1.3464784467348012) psi[0];
cx psi[0], q[18];
rz(1.3464784467348012) q[18];
cx psi[0], q[18];
rz(-1.3464784467348012) q[18];
rz(0.4486357601201907) psi[0];
cx psi[0], q[19];
rz(-0.4486357601201907) q[19];
cx psi[0], q[19];
rz(0.4486357601201907) q[19];
...
cx psi[0], q[22];
rz(-0.4474934273717322) q[22];
cx psi[0], q[22];
rz(0.4474934273717322) q[22];
rz(0.8949868547434644) psi[0];
cx psi[0], q[23];
rz(-0.8949868547434644) q[23];
cx psi[0], q[23];
rz(0.8949868547434644) q[23];
rz(-1.3516189441028643) psi[0];
cx psi[0], q[24];
rz(1.3516189441028643) q[24];
cx psi[0], q[24];
rz(-1.3516189441028643) q[24];
rz(0.43835476538406437) psi[0];
cx psi[0], q[25];
rz(-0.43835476538406437) q[25];
cx psi[0], q[25];
rz(0.43835476538406437) q[25];
cx q[24], q[25];
cx q[25], q[24];
