...
s psi[0];
h psi[0];
rz(0.10236892811607777) psi[0];
cx psi[0], q[0];
rz(-0.10236892811607777) q[0];
cx psi[0], q[0];
rz(0.10236892811607777) q[0];
rz(0.20473785623215554) psi[0];
cx psi[0], q[1];
rz(-0.20473785623215554) q[1];
cx psi[0], q[1];
rz(0.20473785623215554) q[1];
rz(0.4094757124643111) psi[0];
cx psi[0], q[2];
rz(-0.4094757124643111) q[2];
cx psi[0], q[2];
rz(0.4094757124643111) q[2];
rz(0.8189514249286222) psi[0];
cx psi[0], q[3];
rz(-0.8189514249286222) q[3];
cx psi[0], q[3];
rz(0.8189514249286222) q[3];
rz(-1.5036898037325488) psi[0];
cx psi[0], q[4];
rz(1.5036898037325488) q[4];
cx psi[0], q[4];
rz(-1.5036898037325488) q[4];
rz(0.13421304612469565) psi[0];
cx psi[0], q[5];
rz(-0.13421304612469565) q[5];
cx psi[0], q[5];
rz(0.13421304612469565) q[5];
rz(0.2684260922493913) psi[0];
cx psi[0], q[6];
rz(-0.2684260922493913) q[6];
cx psi[0], q[6];
rz(0.2684260922493913) q[6];
rz(0.5368521844987826) psi[0];
cx psi[0], q[7];
rz(-0.5368521844987826) q[7];
cx psi[0], q[7];
rz(0.5368521844987826) q[7];
rz(1.0737043689975652) psi[0];
cx psi[0], q[8];
rz(-1.0737043689975652) q[8];
cx psi[0], q[8];
rz(1.0737043689975652) q[8];
rz(-0.9941839155946629) psi[0];
cx psi[0], q[9];
rz(0.9941839155946629) q[9];
cx psi[0], q[9];
rz(-0.9941839155946629) q[9];
rz(1.1532248224004673) psi[0];
cx psi[0], q[10];
rz(-1.1532248224004673) q[10];
cx psi[0], q[10];
rz(1.1532248224004673) q[10];
rz(-0.8351430087888585) psi[0];
cx psi[0], q[11];
rz(0.8351430087888585) q[11];
cx psi[0], q[11];
rz(-0.8351430087888585) q[11];
rz(1.4713066360120761) psi[0];
cx psi[0], q[12];
rz(-1.4713066360120761) q[12];
cx psi[0], q[12];
rz(1.4713066360120761) q[12];
rz(-0.198979381565641) psi[0];
cx psi[0], q[13];
rz(0.198979381565641) q[13];
cx psi[0], q[13];
rz(-0.198979381565641) q[13];
rz(-0.397958763131282) psi[0];
cx psi[0], q[14];
rz(0.397958763131282) q[14];
cx psi[0], q[14];
rz(-0.397958763131282) q[14];
rz(-0.795917526262564) psi[0];
cx psi[0], q[15];
rz(0.795917526262564) q[15];
cx psi[0], q[15];
rz(-0.795917526262564) q[15];
rz(1.5497576010646652) psi[0];
cx psi[0], q[16];
rz(-1.5497576010646652) q[16];
cx psi[0], q[16];
rz(1.5497576010646652) q[16];
rz(-0.04207745146046254) psi[0];
cx psi[0], q[17];
rz(0.04207745146046254) q[17];
cx psi[0], q[17];
rz(-0.04207745146046254) q[17];
rz(-0.08415490292092508) psi[0];
cx psi[0], q[18];
rz(0.08415490292092508) q[18];
cx psi[0], q[18];
rz(-0.08415490292092508) q[18];
rz(-0.16830980584185015) psi[0];
cx psi[0], q[19];
rz(0.16830980584185015) q[19];
cx psi[0], q[19];
rz(-0.16830980584185015) q[19];
rz(-0.3366196116837003) psi[0];
cx psi[0], q[20];
rz(0.3366196116837003) q[20];
cx psi[0], q[20];
rz(-0.3366196116837003) q[20];
rz(-0.6732392233674006) psi[0];
cx psi[0], q[21];
rz(0.6732392233674006) q[21];
cx psi[0], q[21];
rz(-0.6732392233674006) q[21];
rz(-1.3464784467348012) psi[0];
cx psi[0], q[22];
rz(1.3464784467348012) q[22];
cx psi[0], q[22];
rz(-1.3464784467348012) q[22];
...
cx psi[0], q[25];
rz(1.3470496131090304) q[25];
cx psi[0], q[25];
rz(-1.3470496131090304) q[25];
rz(0.4474934273717322) psi[0];
cx psi[0], q[26];
rz(-0.4474934273717322) q[26];
cx psi[0], q[26];
rz(0.4474934273717322) q[26];
rz(0.8949868547434644) psi[0];
cx psi[0], q[27];
rz(-0.8949868547434644) q[27];
cx psi[0], q[27];
rz(0.8949868547434644) q[27];
cx q[26], q[27];
cx q[27], q[26];
