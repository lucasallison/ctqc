...
s psi[0];
h psi[0];
rz(0.1023521263301747) psi[0];
cx psi[0], q[0];
rz(-0.1023521263301747) q[0];
cx psi[0], q[0];
rz(0.1023521263301747) q[0];
rz(0.2047042526603494) psi[0];
cx psi[0], q[1];
rz(-0.2047042526603494) q[1];
cx psi[0], q[1];
rz(0.2047042526603494) q[1];
rz(0.4094085053206988) psi[0];
cx psi[0], q[2];
rz(-0.4094085053206988) q[2];
cx psi[0], q[2];
rz(0.4094085053206988) q[2];
rz(0.8188170106413976) psi[0];
cx psi[0], q[3];
rz(-0.8188170106413976) q[3];
cx psi[0], q[3];
rz(0.8188170106413976) q[3];
rz(-1.503958632306998) psi[0];
cx psi[0], q[4];
rz(1.503958632306998) q[4];
cx psi[0], q[4];
rz(-1.503958632306998) q[4];
rz(0.13367538897579698) psi[0];
cx psi[0], q[5];
rz(-0.13367538897579698) q[5];
cx psi[0], q[5];
rz(0.13367538897579698) q[5];
rz(0.26735077795159395) psi[0];
cx psi[0], q[6];
rz(-0.26735077795159395) q[6];
cx psi[0], q[6];
rz(0.26735077795159395) q[6];
rz(0.5347015559031879) psi[0];
cx psi[0], q[7];
rz(-0.5347015559031879) q[7];
cx psi[0], q[7];
rz(0.5347015559031879) q[7];
rz(1.0694031118063758) psi[0];
cx psi[0], q[8];
rz(-1.0694031118063758) q[8];
cx psi[0], q[8];
rz(1.0694031118063758) q[8];
rz(-1.0027864299770417) psi[0];
cx psi[0], q[9];
rz(1.0027864299770417) q[9];
cx psi[0], q[9];
rz(-1.0027864299770417) q[9];
...
cx psi[0], q[11];
rz(0.8695530663183734) q[11];
cx psi[0], q[11];
rz(-0.8695530663183734) q[11];
rz(1.4024865209530464) psi[0];
cx psi[0], q[12];
rz(-1.4024865209530464) q[12];
cx psi[0], q[12];
rz(1.4024865209530464) q[12];
rz(-0.3366196116837003) psi[0];
cx psi[0], q[13];
rz(0.3366196116837003) q[13];
cx psi[0], q[13];
rz(-0.3366196116837003) q[13];
rz(-0.6732392233674006) psi[0];
cx psi[0], q[14];
rz(0.6732392233674006) q[14];
cx psi[0], q[14];
rz(-0.6732392233674006) q[14];
rz(-1.3464784467348012) psi[0];
cx psi[0], q[15];
rz(1.3464784467348012) q[15];
cx psi[0], q[15];
rz(-1.3464784467348012) q[15];
rz(0.4486357601201907) psi[0];
cx psi[0], q[16];
rz(-0.4486357601201907) q[16];
cx psi[0], q[16];
rz(0.4486357601201907) q[16];
rz(0.8972715202403814) psi[0];
cx psi[0], q[17];
rz(-0.8972715202403814) q[17];
cx psi[0], q[17];
rz(0.8972715202403814) q[17];
...
cx psi[0], q[19];
rz(-0.4474934273717322) q[19];
cx psi[0], q[19];
rz(0.4474934273717322) q[19];
rz(0.8949868547434644) psi[0];
cx psi[0], q[20];
rz(-0.8949868547434644) q[20];
cx psi[0], q[20];
rz(0.8949868547434644) q[20];
rz(-1.3516189441028643) psi[0];
cx psi[0], q[21];
rz(1.3516189441028643) q[21];
cx psi[0], q[21];
rz(-1.3516189441028643) q[21];
rz(0.43835476538406437) psi[0];
cx psi[0], q[22];
rz(-0.43835476538406437) q[22];
cx psi[0], q[22];
rz(0.43835476538406437) q[22];
...
rz(-pi/4) q[45];
h q[46];
barrier q[0], q[1], q[2], q[3], q[4], q[5], q[6], q[7], q[8], q[9], q[10], q[11], q[12], q[13], q[14], q[15], q[16], q[17], q[18], q[19], q[20], q[21], q[22], q[23], q[24], q[25], q[26], q[27], q[28], q[29], q[30], q[31], q[32], q[33], q[34], q[35], q[36], q[37], q[38], q[39], q[40], q[41], q[42], q[43], q[44], q[45], q[46], psi[0];
c[0] = measure q[0];
c[1] = measure q[1];
c[2] = measure q[2];
c[3] = measure q[3];
