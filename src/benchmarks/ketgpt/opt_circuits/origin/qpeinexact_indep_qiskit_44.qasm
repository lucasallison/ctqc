...
s psi[0];
h psi[0];
rz(0.10244798269880309) psi[0];
cx psi[0], q[0];
rz(-0.10244798269880309) q[0];
cx psi[0], q[0];
rz(0.10244798269880309) q[0];
rz(0.20489596539760618) psi[0];
cx psi[0], q[1];
rz(-0.20489596539760618) q[1];
cx psi[0], q[1];
rz(0.20489596539760618) q[1];
rz(0.40979193079521237) psi[0];
cx psi[0], q[2];
rz(-0.40979193079521237) q[2];
cx psi[0], q[2];
rz(0.40979193079521237) q[2];
rz(0.8195838615904247) psi[0];
cx psi[0], q[3];
rz(-0.8195838615904247) q[3];
cx psi[0], q[3];
rz(0.8195838615904247) q[3];
rz(-1.5024249304089436) psi[0];
cx psi[0], q[4];
rz(1.5024249304089436) q[4];
cx psi[0], q[4];
rz(-1.5024249304089436) q[4];
rz(0.13674279277190593) psi[0];
cx psi[0], q[5];
rz(-0.13674279277190593) q[5];
cx psi[0], q[5];
rz(0.13674279277190593) q[5];
rz(0.27348558554381186) psi[0];
cx psi[0], q[6];
rz(-0.27348558554381186) q[6];
cx psi[0], q[6];
rz(0.27348558554381186) q[6];
rz(0.5469711710876237) psi[0];
cx psi[0], q[7];
rz(-0.5469711710876237) q[7];
cx psi[0], q[7];
rz(0.5469711710876237) q[7];
rz(1.0939423421752474) psi[0];
cx psi[0], q[8];
rz(-1.0939423421752474) q[8];
cx psi[0], q[8];
rz(1.0939423421752474) q[8];
rz(-0.9537079692392985) psi[0];
cx psi[0], q[9];
rz(0.9537079692392985) q[9];
cx psi[0], q[9];
rz(-0.9537079692392985) q[9];
rz(1.2341767151111962) psi[0];
cx psi[0], q[10];
rz(-1.2341767151111962) q[10];
cx psi[0], q[10];
rz(1.2341767151111962) q[10];
rz(-0.6732392233674006) psi[0];
cx psi[0], q[11];
rz(0.6732392233674006) q[11];
cx psi[0], q[11];
rz(-0.6732392233674006) q[11];
rz(-1.3464784467348012) psi[0];
cx psi[0], q[12];
rz(1.3464784467348012) q[12];
cx psi[0], q[12];
rz(-1.3464784467348012) q[12];
rz(0.4486357601201907) psi[0];
cx psi[0], q[13];
rz(-0.4486357601201907) q[13];
cx psi[0], q[13];
rz(0.4486357601201907) q[13];
rz(0.8972715202403814) psi[0];
cx psi[0], q[14];
rz(-0.8972715202403814) q[14];
cx psi[0], q[14];
rz(0.8972715202403814) q[14];
rz(-1.3470496131090304) psi[0];
cx psi[0], q[15];
rz(1.3470496131090304) q[15];
cx psi[0], q[15];
rz(-1.3470496131090304) q[15];
rz(0.4474934273717322) psi[0];
cx psi[0], q[16];
rz(-0.4474934273717322) q[16];
cx psi[0], q[16];
rz(0.4474934273717322) q[16];
rz(0.8949868547434644) psi[0];
cx psi[0], q[17];
rz(-0.8949868547434644) q[17];
cx psi[0], q[17];
rz(0.8949868547434644) q[17];
...
cx psi[0], q[19];
rz(-0.43835476538406437) q[19];
cx psi[0], q[19];
rz(0.43835476538406437) q[19];
rz(0.8767095307681287) psi[0];
cx psi[0], q[20];
rz(-0.8767095307681287) q[20];
cx psi[0], q[20];
rz(0.8767095307681287) q[20];
...
rz(-pi/4) q[41];
h q[42];
barrier q[0], q[1], q[2], q[3], q[4], q[5], q[6], q[7], q[8], q[9], q[10], q[11], q[12], q[13], q[14], q[15], q[16], q[17], q[18], q[19], q[20], q[21], q[22], q[23], q[24], q[25], q[26], q[27], q[28], q[29], q[30], q[31], q[32], q[33], q[34], q[35], q[36], q[37], q[38], q[39], q[40], q[41], q[42], psi[0];
c[0] = measure q[0];
c[1] = measure q[1];
c[2] = measure q[2];
c[3] = measure q[3];
