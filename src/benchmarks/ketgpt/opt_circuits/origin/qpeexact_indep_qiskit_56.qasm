...
s psi[0];
h psi[0];
rz(0.1023690886288168) psi[0];
cx psi[0], q[0];
rz(-0.1023690886288168) q[0];
cx psi[0], q[0];
rz(0.1023690886288168) q[0];
rz(0.2047381772576336) psi[0];
cx psi[0], q[1];
rz(-0.2047381772576336) q[1];
cx psi[0], q[1];
rz(0.2047381772576336) q[1];
rz(0.4094763545152672) psi[0];
cx psi[0], q[2];
rz(-0.4094763545152672) q[2];
cx psi[0], q[2];
rz(0.4094763545152672) q[2];
rz(0.8189527090305344) psi[0];
cx psi[0], q[3];
rz(-0.8189527090305344) q[3];
cx psi[0], q[3];
rz(0.8189527090305344) q[3];
rz(-1.5036872355287243) psi[0];
cx psi[0], q[4];
rz(1.5036872355287243) q[4];
cx psi[0], q[4];
rz(-1.5036872355287243) q[4];
rz(0.13421818253234463) psi[0];
cx psi[0], q[5];
rz(-0.13421818253234463) q[5];
cx psi[0], q[5];
rz(0.13421818253234463) q[5];
rz(0.26843636506468926) psi[0];
cx psi[0], q[6];
rz(-0.26843636506468926) q[6];
cx psi[0], q[6];
rz(0.26843636506468926) q[6];
rz(0.5368727301293785) psi[0];
cx psi[0], q[7];
rz(-0.5368727301293785) q[7];
cx psi[0], q[7];
rz(0.5368727301293785) q[7];
rz(1.073745460258757) psi[0];
cx psi[0], q[8];
rz(-1.073745460258757) q[8];
cx psi[0], q[8];
rz(1.073745460258757) q[8];
rz(-0.9941017330722792) psi[0];
cx psi[0], q[9];
rz(0.9941017330722792) q[9];
cx psi[0], q[9];
rz(-0.9941017330722792) q[9];
rz(1.1533891874452347) psi[0];
cx psi[0], q[10];
rz(-1.1533891874452347) q[10];
cx psi[0], q[10];
rz(1.1533891874452347) q[10];
rz(-0.8348142786993237) psi[0];
cx psi[0], q[11];
rz(0.8348142786993237) q[11];
cx psi[0], q[11];
rz(-0.8348142786993237) q[11];
rz(1.4719640961911458) psi[0];
cx psi[0], q[12];
rz(-1.4719640961911458) q[12];
cx psi[0], q[12];
rz(1.4719640961911458) q[12];
rz(-0.19766446120750153) psi[0];
cx psi[0], q[13];
rz(0.19766446120750153) q[13];
cx psi[0], q[13];
rz(-0.19766446120750153) q[13];
rz(-0.39532892241500306) psi[0];
cx psi[0], q[14];
rz(0.39532892241500306) q[14];
cx psi[0], q[14];
rz(-0.39532892241500306) q[14];
rz(-0.7906578448300061) psi[0];
cx psi[0], q[15];
rz(0.7906578448300061) q[15];
cx psi[0], q[15];
rz(-0.7906578448300061) q[15];
rz(1.5602769639297809) psi[0];
cx psi[0], q[16];
rz(-1.5602769639297809) q[16];
cx psi[0], q[16];
rz(1.5602769639297809) q[16];
rz(-0.02103872573023127) psi[0];
cx psi[0], q[17];
rz(0.02103872573023127) q[17];
cx psi[0], q[17];
rz(-0.02103872573023127) q[17];
rz(-0.04207745146046254) psi[0];
cx psi[0], q[18];
rz(0.04207745146046254) q[18];
cx psi[0], q[18];
rz(-0.04207745146046254) q[18];
rz(-0.08415490292092508) psi[0];
cx psi[0], q[19];
rz(0.08415490292092508) q[19];
cx psi[0], q[19];
rz(-0.08415490292092508) q[19];
rz(-0.16830980584185015) psi[0];
cx psi[0], q[20];
rz(0.16830980584185015) q[20];
cx psi[0], q[20];
rz(-0.16830980584185015) q[20];
rz(-0.3366196116837003) psi[0];
cx psi[0], q[21];
rz(0.3366196116837003) q[21];
cx psi[0], q[21];
rz(-0.3366196116837003) q[21];
rz(-0.6732392233674006) psi[0];
cx psi[0], q[22];
rz(0.6732392233674006) q[22];
cx psi[0], q[22];
rz(-0.6732392233674006) q[22];
rz(-1.3464784467348012) psi[0];
cx psi[0], q[23];
rz(1.3464784467348012) q[23];
cx psi[0], q[23];
rz(-1.3464784467348012) q[23];
...
cx psi[0], q[25];
rz(-0.8972715202403814) q[25];
cx psi[0], q[25];
rz(0.8972715202403814) q[25];
rz(-1.3470496131090304) psi[0];
cx psi[0], q[26];
rz(1.3470496131090304) q[26];
cx psi[0], q[26];
rz(-1.3470496131090304) q[26];
rz(0.4474934273717322) psi[0];
cx psi[0], q[27];
rz(-0.4474934273717322) q[27];
cx psi[0], q[27];
rz(0.4474934273717322) q[27];
rz(-pi/268435456) q[27];
rz(0.8949868547434644) psi[0];
cx psi[0], q[28];
rz(-0.8949868547434644) q[28];
cx psi[0], q[28];
rz(0.8949868547434644) q[28];
cx q[26], q[28];
cx q[28], q[26];
